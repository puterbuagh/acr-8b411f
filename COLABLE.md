...
## Decisions
- **Design System**: Editorial dark UI with felt poker theme (#0a0f0a bg, #1a5f1a accents), oklch color tokens, Fraunces display serif + Inter body + JetBrains Mono code, gradient backgrounds, card shadows, refined spacing and typography hierarchy
